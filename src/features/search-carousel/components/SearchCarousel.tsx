...
export function SearchCarousel() {
  ...
  const handleNextPrevSlide = (option: "next" | "prev") => {
    if (option === "next") {
  ...
  return (
    <section className="my-8 md:my-14 transition-all duration-500">
      <div
        className="
          rounded-[2rem] bg-[#6c757d] bg-cover bg-center bg-no-repeat
          px-[2rem] py-[4rem]
          md:px-[1.8rem] md:pt-[4rem] md:pb-[8.12rem]
          lg:px-[4rem] lg:pt-[4.5rem] lg:pb-[8.12rem]
          2xl:px-[4.19rem] 2xl:pt-[8.5rem] 2xl:pb-[8.12rem] 2xl:pl-[7.5rem]
          [@media(min-width:1501px)]:px-[5.19rem]
          [@media(min-width:1501px)]:pt-[9.5rem]
          [@media(min-width:1501px)]:pb-[9.12rem]
          [@media(min-width:1501px)]:pl-[8.5rem]
        "
        style={{
          backgroundImage: `linear-gradient(
            ...
            rgba(0, 0, 0, 0.30) 0%,
            rgba(0, 0, 0, 0.22) 100%
          ), url(${currentPlace.img_url})`,
        }}
      >
        {/* Title */}
        <div className="mb-8 md:mb-10">
          <p className="relative ml-10 capitalize text-white text-base font-normal">
            <span className="absolute left-[-2.5rem] top-[0.75rem] h-[0.125rem] w-6 bg-white md:top-[1rem]" />
          ...
          <h1
            className="
              ...
              text-4xl md:text-5xl lg:text-6xl xl:text-[7rem] 2xl:text-[8rem]
        ...
        <div className="flex flex-col-reverse justify-between lg:flex-row">
            ...
            <div className="flex gap-4">
              ...
              >
                <Image
                  ...
                  width={32}
                  height={32}
                  className="w-[2.3rem] h-auto md:w-8"
                />
              </button>
          ...
          <div className="flex items-center">
            ...
            <div>
              <p className="mb-2 text-white text-base font-normal leading-snug">
                We Accept Payment Through <br />
                All Cards & Banking
              </p>

              <p className="font-semibold underline text-white text-base">
                Book Now!
              </p>
            </div>
          </div>
